...
import VendorDeleteP from "../UI/VendorDeleteP";
import car from "../../assets/all-images/cars-img/mercedes-offer.png"

const CarItemSeller = (props) => {
      ...
      <div className="car__item">
        ...
        <div className="car__item-content mt-4">
          ...
          <button className=" w-50 car__item-btn car__btn-rent">
            <Link to={`/carEdit/${P_ID}`}>Update</Link>
          </button>
          <Link to="/sellerDashboard">
            <VendorDeleteP id={P_ID} />
          </Link>
          {/* <button className=" w-50 car__item-btn car__btn-details">
            <Link to={`/cars/${P_ID}`}>Delete</Link>
          </button> */}
        </div>
      </div>
    </Col>
